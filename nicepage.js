          ...
          if (
            ...
            if (services.length)
              a(form, {
                ...
                showSuccess: c,
                success: function () {
                  if (!c) o(form, { url: url, method: i, redirectAddress: n });
                },
              });
            else o(form, { url: url, method: i, redirectAddress: n });
          }
        },
        click: function (t) {
          t.preventDefault(),
      ...
      l.ajax({
        ...
        .done(function (data, e) {
          if (
            ...
            if (t.redirectAddress) window.location.replace(t.redirectAddress);
            else t.success(form);
            ...
            var t,
              ...
              n = {
                ...
                panAnimLoop: function () {
                  if (Rt.zoomPan)
                    if (
                      ((Rt.zoomPan.raf = Y(n.panAnimLoop)),
                      (n.now = ct()),
